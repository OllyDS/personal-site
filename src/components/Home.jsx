          ...
          <Grid className="skills">
            <Grid.Row centered columns={2}>
              <Image.Group size="tiny">
                ...
                <Image src="/images/python-icon.png" alt="python" className="mobile-icons"/>
              </Image.Group>
              <Image.Group size="tiny">
                <Image src="/images/js-icon.png" alt="javascript" className="mobile-icons"/>
                <Image src="/images/typescript-icon.png" alt="typescript" className="mobile-icons"/>
              </Image.Group>
              <Image.Group size="tiny">
        ...
        <Container className="lang-icons-parent">
          ...
          <Grid className="skills">
            <Grid.Row centered columns={5}>
              ...
              <Image src="/images/typescript-icon.png" alt="typescript" className="desktop-icons"/>
            ...
            <Grid.Row centered columns={5}>
              <Image.Group size="tiny">
              <Image src="/images/python-icon.png" alt="python" className="desktop-icons"/>
