    ...
    <SContainer>
      <Grid>
        <Cell width={12} mdWidth={4} mdLeft={2}>
          ...
          <SText>
            The backedn uses Python and Quart (An open-source extension of Flask that has async/await
    ...
    <SContainer>
      <Grid>
        ...
        <SSubHeader>
          ...
          <SText>
            We wrote the site in TypeScript, React and Redux and utilise an open-source CMS system which we have also contributed to.
          </SText>
        </Cell>
